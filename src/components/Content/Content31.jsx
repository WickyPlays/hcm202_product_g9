  ...
  return (
    <div className="content-31">
       <div className='intro' style={{backgroundImage: 'url(' + vinhhalong + ')' }}>
        ...
        <p className='title'><span className='node'>3</span> Câu hỏi CQ</p>
        <p className='question'>"Dĩ bất biến, ứng vạn biến" của Hồ Chí Minh có phải là khởi đầu của trường phái ngoại giao "Cây tre Việt Nam" hiện nay?</p>
      </div>
    </div>
  )
}